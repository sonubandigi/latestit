...
<body>
  ...
  <nav class="navbar navbar-expand-sm fixed-top">
    <div class="container-fluid">
      <a class="navbar-brand" href="javascript:void(0)"><img src="images/logo.png" class="img-fluid" alt="..."></a>
      ...
      <div class="collapse navbar-collapse" id="mynavbar">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="payment.html"><button>Client Payment</button></a>
          </li>
        </ul>
      </div>
    </div>
...
<div class="overview">
  <div class="inover">
    <div class="overtext">
      <a href="index.html"><span>Home</span></a>&nbsp;<i class="fa-solid fa-angle-right"></i>&nbsp;&nbsp;<a href="gallery.html"><span>Gallery</span></a>&nbsp;&nbsp;<i class="fa-solid fa-angle-right"></i>&nbsp;&nbsp;
    </div>
    <div class="company">
      <h2>Gallery</h2>
      </div>
...
<div class="container-fluid" style="margin-top: 50px; margin-bottom: 50px;">
    <h1 class="service">Gallery</h1>
    <img src="images/under-heading.png" alt="" class="unhead">
</div>
    <div class="container servicerow">
        <div class="row">
           <div class="col-md-4">
           
            <a href="#"><img src="RetrieveImg1?id=1" width="400" height="400"></a>
           <h6 class="head6">WEB APPLICATION DEVELOPMENT</h6>
           </div>
           <div class="col-md-4">
            <a href="#"><img src="RetrieveImg1?id=2" width="400" height="400"></a>
           <h6 class="head6">E-COMMERCE DEVELOPMENT</h6>
           </div>
           <div class="col-md-4">
            <a href="#"><img src="RetrieveImg1?id=3" width="400" height="400"	></a>
           <h6 class="head6">DIGITAL MARKETING</h6>
           </div>
